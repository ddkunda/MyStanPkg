...
#include "stanExports_my_stan_model1.h"

RCPP_MODULE(stan_fit4my_stan_model1_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_my_stan_model1")
